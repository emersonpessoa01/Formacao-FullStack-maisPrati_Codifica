...
3. Introdução à Lógica de Programação e JavaScript Básico
4. [Onboarding RH?], Estruturas de Controle: Repetição e Funções Básicas
5. Arrays e Funções Avançadas
6. Criação e Manipulação de Objetos em JavaScript
7. Revisão e Finalização do Módulo

### Módulo 2 - Introdução ao Controle de Versão com Git e GitHub (2 Aulas)
1. Introdução ao Git e GitHub
2. Comandos Essenciais do Git e Trabalho Colaborativo
